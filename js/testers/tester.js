...
class Tester {
    ...
    toBeEqualTo(label, actual, expected, fieldName) {
        this.report.push({
            label: label,
    ...
    toBeGreaterThan(label, actual, expected, fieldName) {
        this.report.push({
            label: label,
            valid: actual > expected,
    ...
    toBeGreaterThanOrEqualTo(label, actual, expected, fieldName) {
        this.report.push({
            label: label,
            valid: actual >= expected,
    ...
    toBeLessThan(label, actual, expected, fieldName) {
        this.report.push({
            label: label,
            valid: actual < expected,
    ...
    toBeLessThanOrEqualTo(label, actual, expected, fieldName) {
        this.report.push({
            label: label,
            valid: actual <= expected,
    ...
    toContain(label, expected, toContain, fieldName) {
        this.report.push({
            label: label,
    ...
    expectToBeTruthy(label, expected, fieldName) {
        this.report.push({
            label: label,
            valid: !!expected,
    ...
    expectToBeFalsy(label, expected, fieldName) {
        this.report.push({
            label: label,
            valid: !expected,
    ...
    expectToBeDefined(label, defined, fieldName) {
        this.report.push({
            label: label,
    ...
    expectToBeUndefined(label, defined, fieldName) {
        this.report.push({
            label: label,
            valid: defined === undefined,
