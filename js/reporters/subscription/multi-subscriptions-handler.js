...
class MultiSubscriptionsHandler {
    constructor(subscriptionsAttributes) {
        ...
        for (let id = 0; id < subscriptionsAttributes.length; ++id) {
            this.subscriptionHandlers.push(new subscription_handler_1.SubscriptionHandler(subscriptionsAttributes[id]));
        }
    }
    connect() {
...
exports.MultiSubscriptionsHandler = MultiSubscriptionsHandler;
